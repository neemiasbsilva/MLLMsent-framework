...
def predict(X_test, model, tokenizer):
    ...
    return y_pred
# def predict(X_test, model, tokenizer):
#     """Predict labels for test data using dataset for better GPU efficiency."""
...
#     # Use the pipeline with the dataset
#     results = pipe(test_dataset["text"], batch_size=16)  # Adjust batch_size based on your GPU memory
